...
contract ArcoinPaymentRouter is Ownable, ReentrancyGuard {
    ...
    function routePayment(
        ...
        // NOTE: forceApprove (not the deprecated safeApprove) is used because
        // safeApprove reverts whenever the existing allowance is non-zero,
        // which would break every payment after the first if any dust
        // allowance was left over.
        if (fee > 0) {
